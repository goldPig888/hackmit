"""Advanced HALO pipeline with camera-frame realignment and CPA-based collision detection."""
...
class AdvancedPipelineConfig:
    """Configuration for advanced HALO pipeline."""
...
class AdvancedHaloPipeline:
    """Advanced HALO pipeline with camera-frame realignment.
    ...
    def __init__(self, config: Optional[AdvancedPipelineConfig] = None):
        """Initialize advanced HALO pipeline.
